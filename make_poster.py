...
# ── Logo — top-left corner, centered vertically in header ────────────────────
...
TAG_RESERVE = 90
LOGO_Y   = (HDR_H - TAG_RESERVE - LOGO_H) // 2
canvas.paste(logo_img, (PAD, LOGO_Y))

# ── Brand: PHONE (white) ElectriK (orange) — right of logo, same center ──────
logo_r     = PAD + LOGO_W + 30
